{include file='companies/inc/tabs.tpl'}
<div class="manager-content">
	...
	<form action="/manager/companies/save/" method="post" class="form" enctype="multipart/form-data">
		...
		{if $request->image != ''}
			<div class="form-item">
				<img src="/images/companies/{$request->image}" />
			</div>
		{/if}
		<div class="form-item">
		...
		{if $request->big_image != ''}
			<div class="form-item">
                <img width="140" height="100" src="/images/companies/{$request->big_image}" />
			</div>
		{/if}
		<div class="form-item">
