...
<div class="manager-content">
    ...
    <div class="manager-list{cycle values=', gray-bg'}">
        ...
        <div class="manager-list-content">
            <a href="/manager/companies/edit/id/{$item->product_id}/">{$item->title}</a>&nbsp;&nbsp;&nbsp;
        </div>
        <div class="manager-list-controls">
            <a href="/manager/companies/edit/id/{$item->product_id}">
                <img src="/images/admin/edit.png" alt="Редактировать" />
            </a>			
            <a href="/manager/companies/delete/id/{$item->product_id}">
